// Package jsoncolor provides colorized JSON output functionality.
// This implementation is adapted from GitHub CLI's jsoncolor package:
// https://github.com/cli/cli/blob/trunk/pkg/jsoncolor/jsoncolor.go
