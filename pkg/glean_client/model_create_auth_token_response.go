...
type _CreateAuthTokenResponse CreateAuthTokenResponse
...
func (o *CreateAuthTokenResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateAuthTokenResponse := _CreateAuthTokenResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateAuthTokenResponse)

	if err != nil {
		return err
	}

	*o = CreateAuthTokenResponse(varCreateAuthTokenResponse)
