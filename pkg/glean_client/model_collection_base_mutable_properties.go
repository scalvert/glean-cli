...
type _CollectionBaseMutableProperties CollectionBaseMutableProperties
...
func (o *CollectionBaseMutableProperties) UnmarshalJSON(data []byte) (err error) {
	...
	varCollectionBaseMutableProperties := _CollectionBaseMutableProperties{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCollectionBaseMutableProperties)

	if err != nil {
		return err
	}

	*o = CollectionBaseMutableProperties(varCollectionBaseMutableProperties)
