...
type _CollectionPinMetadata CollectionPinMetadata
...
func (o *CollectionPinMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varCollectionPinMetadata := _CollectionPinMetadata{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCollectionPinMetadata)

	if err != nil {
		return err
	}

	*o = CollectionPinMetadata(varCollectionPinMetadata)
