...
func (o *AnswerBoard) UnmarshalJSON(data []byte) (err error) {
	...
	varAnswerBoard := _AnswerBoard{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAnswerBoard)

	if err != nil {
		return err
	}

	*o = AnswerBoard(varAnswerBoard)
