...
func (o *FeedResult) UnmarshalJSON(data []byte) (err error) {
	...
	varFeedResult := _FeedResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFeedResult)

	if err != nil {
		return err
	}

	*o = FeedResult(varFeedResult)
