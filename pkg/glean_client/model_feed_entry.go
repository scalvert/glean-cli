...
func (o *FeedEntry) UnmarshalJSON(data []byte) (err error) {
	...
	varFeedEntry := _FeedEntry{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFeedEntry)

	if err != nil {
		return err
	}

	*o = FeedEntry(varFeedEntry)
