...
func (r ApiMessagesRequest) XScioActas(xScioActas string) ApiMessagesRequest {
...
*/
func (a *MessagesAPIService) Messages(ctx context.Context) ApiMessagesRequest {
	return ApiMessagesRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *MessagesAPIService) MessagesExecute(r ApiMessagesRequest) (*MessagesResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "MessagesAPIService.Messages")
	if err != nil {
