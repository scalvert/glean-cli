...
type _AutocompleteResult AutocompleteResult
...
func (o *AutocompleteResult) UnmarshalJSON(data []byte) (err error) {
	...
	varAutocompleteResult := _AutocompleteResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAutocompleteResult)

	if err != nil {
		return err
	}

	*o = AutocompleteResult(varAutocompleteResult)
