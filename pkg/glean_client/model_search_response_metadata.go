...
// GetAdditionalQuerySuggestions returns the AdditionalQuerySuggestions field value if set, zero value otherwise.
func (o *SearchResponseMetadata) GetAdditionalQuerySuggestions() QuerySuggestionList {
	if o == nil || IsNil(o.AdditionalQuerySuggestions) {
...
// GetAdditionalQuerySuggestionsOk returns a tuple with the AdditionalQuerySuggestions field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SearchResponseMetadata) GetAdditionalQuerySuggestionsOk() (*QuerySuggestionList, bool) {
	if o == nil || IsNil(o.AdditionalQuerySuggestions) {
		return nil, false
	}
	return o.AdditionalQuerySuggestions, true
}
...
// SetAdditionalQuerySuggestions gets a reference to the given QuerySuggestionList and assigns it to the AdditionalQuerySuggestions field.
func (o *SearchResponseMetadata) SetAdditionalQuerySuggestions(v QuerySuggestionList) {
	o.AdditionalQuerySuggestions = &v
}
...
func (o SearchResponseMetadata) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AdditionalQuerySuggestions) {
		toSerialize["additionalQuerySuggestions"] = o.AdditionalQuerySuggestions
	}
