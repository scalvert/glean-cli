...
type _AnswerBoardResult AnswerBoardResult
...
func (o *AnswerBoardResult) UnmarshalJSON(data []byte) (err error) {
	...
	varAnswerBoardResult := _AnswerBoardResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAnswerBoardResult)

	if err != nil {
		return err
	}

	*o = AnswerBoardResult(varAnswerBoardResult)
