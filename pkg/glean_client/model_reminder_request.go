...
type _ReminderRequest ReminderRequest
...
func (o *ReminderRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varReminderRequest := _ReminderRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varReminderRequest)

	if err != nil {
		return err
	}

	*o = ReminderRequest(varReminderRequest)
