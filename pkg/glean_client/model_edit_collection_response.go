...
type _EditCollectionResponse EditCollectionResponse
...
func (o *EditCollectionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varEditCollectionResponse := _EditCollectionResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEditCollectionResponse)

	if err != nil {
		return err
	}

	*o = EditCollectionResponse(varEditCollectionResponse)
