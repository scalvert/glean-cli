...
func (o *PinDocument) UnmarshalJSON(data []byte) (err error) {
	...
	varPinDocument := _PinDocument{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPinDocument)

	if err != nil {
		return err
	}

	*o = PinDocument(varPinDocument)
