...
func (o *FeedRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varFeedRequest := _FeedRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varFeedRequest)

	if err != nil {
		return err
	}

	*o = FeedRequest(varFeedRequest)
