...
type _CreateAnswerRequest CreateAnswerRequest
...
func (o *CreateAnswerRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateAnswerRequest := _CreateAnswerRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateAnswerRequest)

	if err != nil {
		return err
	}

	*o = CreateAnswerRequest(varCreateAnswerRequest)
