...
type _GetDisplayableListsResponse GetDisplayableListsResponse
...
func (o *GetDisplayableListsResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varGetDisplayableListsResponse := _GetDisplayableListsResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetDisplayableListsResponse)

	if err != nil {
		return err
	}

	*o = GetDisplayableListsResponse(varGetDisplayableListsResponse)
