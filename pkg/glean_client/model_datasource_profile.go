...
type _DatasourceProfile DatasourceProfile
...
func (o *DatasourceProfile) UnmarshalJSON(data []byte) (err error) {
	...
	varDatasourceProfile := _DatasourceProfile{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varDatasourceProfile)

	if err != nil {
		return err
	}

	*o = DatasourceProfile(varDatasourceProfile)
