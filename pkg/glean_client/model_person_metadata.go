...
// GetIsOrgRoot returns the IsOrgRoot field value if set, zero value otherwise.
func (o *PersonMetadata) GetIsOrgRoot() bool {
	if o == nil || IsNil(o.IsOrgRoot) {
		var ret bool
		return ret
	}
	return *o.IsOrgRoot
...
// GetIsOrgRootOk returns a tuple with the IsOrgRoot field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *PersonMetadata) GetIsOrgRootOk() (*bool, bool) {
	if o == nil || IsNil(o.IsOrgRoot) {
		return nil, false
	}
	return o.IsOrgRoot, true
}
...
// SetIsOrgRoot gets a reference to the given bool and assigns it to the IsOrgRoot field.
...
func (o PersonMetadata) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.IsOrgRoot) {
		toSerialize["isOrgRoot"] = o.IsOrgRoot
	}
