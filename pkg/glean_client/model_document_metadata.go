...
// GetSuperContainerId returns the SuperContainerId field value if set, zero value otherwise.
func (o *DocumentMetadata) GetSuperContainerId() string {
	if o == nil || IsNil(o.SuperContainerId) {
		var ret string
		return ret
	}
...
// GetSuperContainerIdOk returns a tuple with the SuperContainerId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *DocumentMetadata) GetSuperContainerIdOk() (*string, bool) {
	if o == nil || IsNil(o.SuperContainerId) {
		return nil, false
	}
	return o.SuperContainerId, true
}
...
// SetSuperContainerId gets a reference to the given string and assigns it to the SuperContainerId field.
func (o *DocumentMetadata) SetSuperContainerId(v string) {
	o.SuperContainerId = &v
}
...
// SetAncestors gets a reference to the given []Document and assigns it to the Ancestors field.
...
func (o DocumentMetadata) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.SuperContainerId) {
		toSerialize["superContainerId"] = o.SuperContainerId
	}
	if !IsNil(o.ParentId) {
