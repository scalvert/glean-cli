...
// checks if the CreateCollectionResponse type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateCollectionResponse{}
...
type _CreateCollectionResponse CreateCollectionResponse
...
func (o CreateCollectionResponse) ToMap() (map[string]interface{}, error) {
...
func (o *CreateCollectionResponse) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateCollectionResponse := _CreateCollectionResponse{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varCreateCollectionResponse)

	if err != nil {
		return err
	}

	*o = CreateCollectionResponse(varCreateCollectionResponse)
...
func NewNullableCreateCollectionResponse(val *CreateCollectionResponse) *NullableCreateCollectionResponse {
	return &NullableCreateCollectionResponse{value: val, isSet: true}
}
