...
type _PersonToTeamRelationship PersonToTeamRelationship
...
func (o *PersonToTeamRelationship) UnmarshalJSON(data []byte) (err error) {
	...
	varPersonToTeamRelationship := _PersonToTeamRelationship{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varPersonToTeamRelationship)

	if err != nil {
		return err
	}

	*o = PersonToTeamRelationship(varPersonToTeamRelationship)
