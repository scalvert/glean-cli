...
type _OperatorMetadata OperatorMetadata
...
func (o *OperatorMetadata) UnmarshalJSON(data []byte) (err error) {
	...
	varOperatorMetadata := _OperatorMetadata{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varOperatorMetadata)

	if err != nil {
		return err
	}

	*o = OperatorMetadata(varOperatorMetadata)
