...
type _GetDisplayableListsRequest GetDisplayableListsRequest
...
func (o *GetDisplayableListsRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varGetDisplayableListsRequest := _GetDisplayableListsRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varGetDisplayableListsRequest)

	if err != nil {
		return err
	}

	*o = GetDisplayableListsRequest(varGetDisplayableListsRequest)
