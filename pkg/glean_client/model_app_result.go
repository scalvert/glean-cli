...
func (o *AppResult) UnmarshalJSON(data []byte) (err error) {
	...
	varAppResult := _AppResult{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varAppResult)

	if err != nil {
		return err
	}

	*o = AppResult(varAppResult)
