...
type _EditAnswerRequest EditAnswerRequest
...
func (o *EditAnswerRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varEditAnswerRequest := _EditAnswerRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varEditAnswerRequest)

	if err != nil {
		return err
	}

	*o = EditAnswerRequest(varEditAnswerRequest)
