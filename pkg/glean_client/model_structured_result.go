...
// GetRelatedQuestion returns the RelatedQuestion field value if set, zero value otherwise.
func (o *StructuredResult) GetRelatedQuestion() RelatedQuestion {
	if o == nil || IsNil(o.RelatedQuestion) {
		var ret RelatedQuestion
		return ret
	}
	return *o.RelatedQuestion
}

// GetRelatedQuestionOk returns a tuple with the RelatedQuestion field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *StructuredResult) GetRelatedQuestionOk() (*RelatedQuestion, bool) {
	if o == nil || IsNil(o.RelatedQuestion) {
		return nil, false
	}
	return o.RelatedQuestion, true
}
...
// SetRelatedQuestion gets a reference to the given RelatedQuestion and assigns it to the RelatedQuestion field.
...
func (o StructuredResult) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.RelatedQuestion) {
		toSerialize["relatedQuestion"] = o.RelatedQuestion
	}
	if !IsNil(o.Snippets) {
