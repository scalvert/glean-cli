...
type _UpdateShortcutRequest UpdateShortcutRequest
...
func (o *UpdateShortcutRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateShortcutRequest := _UpdateShortcutRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateShortcutRequest)

	if err != nil {
		return err
	}

	*o = UpdateShortcutRequest(varUpdateShortcutRequest)
