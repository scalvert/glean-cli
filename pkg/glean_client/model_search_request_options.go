...
type _SearchRequestOptions SearchRequestOptions
...
// GetFacetFilterSets returns the FacetFilterSets field value if set, zero value otherwise.
func (o *SearchRequestOptions) GetFacetFilterSets() []FacetFilterSet {
	if o == nil || IsNil(o.FacetFilterSets) {
		var ret []FacetFilterSet
		return ret
	}
	return o.FacetFilterSets
}

// GetFacetFilterSetsOk returns a tuple with the FacetFilterSets field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SearchRequestOptions) GetFacetFilterSetsOk() ([]FacetFilterSet, bool) {
	if o == nil || IsNil(o.FacetFilterSets) {
		return nil, false
	}
	return o.FacetFilterSets, true
}
...
// SetFacetFilterSets gets a reference to the given []FacetFilterSet and assigns it to the FacetFilterSets field.
...
// GetDefaultFacets returns the DefaultFacets field value if set, zero value otherwise.
func (o *SearchRequestOptions) GetDefaultFacets() []string {
	if o == nil || IsNil(o.DefaultFacets) {
		var ret []string
		return ret
	}
...
// GetDefaultFacetsOk returns a tuple with the DefaultFacets field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SearchRequestOptions) GetDefaultFacetsOk() ([]string, bool) {
	if o == nil || IsNil(o.DefaultFacets) {
		return nil, false
	}
	return o.DefaultFacets, true
}
...
// SetDefaultFacets gets a reference to the given []string and assigns it to the DefaultFacets field.
...
// GetReturnLlmContentOverSnippets returns the ReturnLlmContentOverSnippets field value if set, zero value otherwise.
func (o *SearchRequestOptions) GetReturnLlmContentOverSnippets() bool {
	if o == nil || IsNil(o.ReturnLlmContentOverSnippets) {
		var ret bool
		return ret
	}
...
// GetReturnLlmContentOverSnippetsOk returns a tuple with the ReturnLlmContentOverSnippets field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *SearchRequestOptions) GetReturnLlmContentOverSnippetsOk() (*bool, bool) {
	if o == nil || IsNil(o.ReturnLlmContentOverSnippets) {
		return nil, false
	}
	return o.ReturnLlmContentOverSnippets, true
}
...
// SetReturnLlmContentOverSnippets gets a reference to the given bool and assigns it to the ReturnLlmContentOverSnippets field.
func (o *SearchRequestOptions) SetReturnLlmContentOverSnippets(v bool) {
	o.ReturnLlmContentOverSnippets = &v
}
...
func (o SearchRequestOptions) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.FacetFilterSets) {
		toSerialize["facetFilterSets"] = o.FacetFilterSets
	}
	...
	if !IsNil(o.DefaultFacets) {
		toSerialize["defaultFacets"] = o.DefaultFacets
	}
	...
	if !IsNil(o.ReturnLlmContentOverSnippets) {
		toSerialize["returnLlmContentOverSnippets"] = o.ReturnLlmContentOverSnippets
	}
	return toSerialize, nil
}

func (o *SearchRequestOptions) UnmarshalJSON(data []byte) (err error) {
	...
	varSearchRequestOptions := _SearchRequestOptions{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSearchRequestOptions)

	if err != nil {
		return err
	}

	*o = SearchRequestOptions(varSearchRequestOptions)
