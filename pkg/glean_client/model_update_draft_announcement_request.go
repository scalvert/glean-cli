...
type _UpdateDraftAnnouncementRequest UpdateDraftAnnouncementRequest
...
func (o *UpdateDraftAnnouncementRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varUpdateDraftAnnouncementRequest := _UpdateDraftAnnouncementRequest{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varUpdateDraftAnnouncementRequest)

	if err != nil {
		return err
	}

	*o = UpdateDraftAnnouncementRequest(varUpdateDraftAnnouncementRequest)
