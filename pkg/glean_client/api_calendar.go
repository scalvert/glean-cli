...
func (r ApiGeteventsRequest) XScioActas(xScioActas string) ApiGeteventsRequest {
...
*/
func (a *CalendarAPIService) Getevents(ctx context.Context) ApiGeteventsRequest {
	return ApiGeteventsRequest{
		ApiService: a,
		ctx: ctx,
	}
...
func (a *CalendarAPIService) GeteventsExecute(r ApiGeteventsRequest) (*GetEventsResponse, *http.Response, error) {
	var (
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "CalendarAPIService.Getevents")
	if err != nil {
