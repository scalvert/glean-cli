...
type _QuerySuggestion QuerySuggestion
...
func (o *QuerySuggestion) UnmarshalJSON(data []byte) (err error) {
	...
	varQuerySuggestion := _QuerySuggestion{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varQuerySuggestion)

	if err != nil {
		return err
	}

	*o = QuerySuggestion(varQuerySuggestion)
